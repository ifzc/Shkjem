    ...
    <div id="adminnewsbox">
        ...
        <el-row>
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="Remark" label="企业名称">
                </el-table-column>
    ...
    methods: {
        ...
        deleteClick (row) {
            ...
            this.$confirm('删除"' + row.Title + '", 是否继续?', "提示", {
                ...
                .then(() => {
                    axios
                        .post("/enterprise/DeleteEnterprise/" + row.Id, '', config)
                        .then(response => {
        ...
        createEntity () {
            axios
                .post("/enterprise/CreatedofModied", {
                    Id: this.form.id,
                    Img: this.form.img,
        ...
        getdataall () {
            axios
                .get("/enterprise/GetEnterpriseAll", '', config)
                .then(response => {
